...
export default function TaoHoSoGiaHanPage() {
  ...
  const [truongHop, setTruongHop] = useState<DropdownItem | null>(TRUONG_HOP_ITEMS[0]);
  ...
  const [noiDungDeNghi, setNoiDungDeNghi] = useState('Gia hạn tạm trú - Gia hạn tạm trú theo danh sách');
