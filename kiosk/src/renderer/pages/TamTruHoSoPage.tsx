...
export default function TamTruHoSoPage() {
  ...
  const handleNext = () => {
    if (!answer) return;
    navigate(answer === 'no' ? '/tao-khai-bao-tam-vang' : '/scan-tam-tru');
  };
    ...
    <>
      <div className="ltrhs-area">
        ...
        <div className="ltrhs-question">
          <div className="ltrhs-question-header">
            <p className="ltrhs-question-text">
              Bạn có <strong>ĐƠN ĐĂNG KÝ TẠM TRÚ</strong> chưa?
            </p>
            <a
              href="#"
          ...
          <div className="ltrhs-options" data-question="don-tam-tru">
            <button
              type="button"
        ...
        <div className="ltrhs-footer">
          <button
            type="button"
            className="ltrhs-btn ltrhs-btn--back"
            onClick={() => navigate(-1)}
          >
      ...
      >
        <div className="maudon-container" onClick={(e) => e.stopPropagation()}>
          ...
          <img
            src="/assets/mau-tam-tru.svg"
            alt="Mẫu đơn đăng ký tạm trú"
